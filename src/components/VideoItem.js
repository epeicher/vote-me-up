    ...
    return (
      <Card style={video.viewed ? styles.viewed : {}}>
        ...
        >
          <div key={video.id}>
            <CardHeader
              avatar={<Avatar>{video.votes || '0'}</Avatar>}
              title={video.title}
              //subheader="September 2018"   <-- NICE TO HAVE!
            />
            <CardContent
              style={{ paddingTop: 0, paddingBottom: 5, marginLeft: 58 }}
            >
            ...
            <CardActions
              ...
              className={this.props.user ? '' : 'hide'}
            >
              ...
              <div style={{ marginLeft: 'auto', marginRight: 8 }}>
                ...
                {video.viewed ? (
                  <IconButton aria-label="Mark as not viewed">
                    <CheckBoxIcon
                      onClick={e => this.handleViewed(e, false, video.id)}
                    />
                  </IconButton>
                ) : (
                  <IconButton aria-label="Mark as viewed">
                    <CheckBoxOutlineBlankIcon
                      onClick={e => this.handleViewed(e, true, video.id)}
                    />
                  </IconButton>
                )}
              </div>
